...
clients, including series list/detail/lookup, manga-native calendar buckets,
profiles, root folders, queue, history, wanted, cutoff-unmet, blocklist,
commands, system status, series patch/delete/restore, and command execution.
